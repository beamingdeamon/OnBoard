...
const getTemplatesList = async () => {
    await axios.get("/api/v1/hrd/mail_templates").then(async (res) => {
...
const getTemplateInfo = async (id) => {
    await axios.get("/api/v1/hrd/mail_templates/" + id).then((res) => {
...
const addTemplate = async () => {
    await axios.post("/api/v1/hrd/mail_templates").then(() => {
        console.log("success");
        getTemplatesList();
    ...
    await formEl.validate(async (valid, fields) => {
        if (valid) {
            try {
                await axios
                    .put(
                        `/api/v1/hrd/mail_templates/${currentTemplate.value.id}`,
...
const deleteTemplate = async (id) => {
    await axios.delete("/api/v1/hrd/mail_templates/" + id).then(() => {
